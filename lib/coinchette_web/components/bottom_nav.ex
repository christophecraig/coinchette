defmodule CoinchetteWeb.BottomNav do
    ...
    <nav class={[
      ...
      <div class="flex items-center justify-around h-16 max-w-lg mx-auto px-2">
        ...
        <.nav_item
          ...
          icon="trophy"
          label="Classement"
          active={@current_path == "/leaderboard"}
  ...
  defp nav_icon(%{name: "trophy"} = assigns) do
    ~H"""
    <svg class={@class} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
        stroke-width="2"
        d="M8 21h8m-4-4v4m-4.5-9.5L7 4h10l-.5 7.5M7 4H4l1 7h2M17 4h3l-1 7h-2M12 15a4 4 0 01-4-4h8a4 4 0 01-4 4z"
      />
    </svg>
    """
  end
